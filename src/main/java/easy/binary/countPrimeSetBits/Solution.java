package easy.binary.countPrimeSetBits;
 ...
 * 个计算置位，2 是质数)
 *
 * Write a helper function to count the easy.number of set bits in a easy.number, then check whether the
 * easy.number of set bits is 2, 3, 5, 7, 11, 13, 17 or 19.
 * @Author : lguo
